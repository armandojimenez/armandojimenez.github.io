...
(function ($) {
    ...
    function initLeadBackground() {
        ...
        var icons = ['fa-code', 'fa-terminal', 'fa-laptop', 'fa-mobile', 'fa-database', 'fa-server', 'fa-bug', 'fa-keyboard-o', 'fa-gamepad', 'fa-headphones', 'fa-coffee', 'fa-heart', 'fa-star', 'fa-cloud', 'fa-wifi', 'fa-lock', 'fa-shield', 'fa-html5', 'fa-css3', 'fa-linux', 'fa-apple', 'fa-android', 'fa-windows', 'fa-chrome', 'fa-firefox', 'fa-git', 'fa-github', 'fa-cogs', 'fa-rocket', 'fa-bolt', 'fa-magic'];
